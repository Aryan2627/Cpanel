const fs = require('fs');
let code = fs.readFileSync('src/app/client/events/create/auction/page.tsx', 'utf8');
...
fs.writeFileSync('src/app/client/events/create/auction/page.tsx', code, 'utf8');
console.log('Fixed Auction Modal');
