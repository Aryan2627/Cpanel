                        ...
                        <div style={{ padding:'18px 20px', display:'flex', flexDirection:'column', gap:'13px' }}>
                          ...
                          <div>
                            ...
                            <div style={{position:'relative'}}>
                              ...
                              <input type="text" placeholder="0.00" value={eventForm.budget} onChange={e=>setEventForm({...eventForm, budget:e.target.value})} style={{ width:'100%', padding:'10px 13px 10px 24px', borderRadius:'6px', border: isDark ? '1px solid #334155' : '1px solid #cbd5e1', background: isDark ? '#0f172a' : '#ffffff', color: isDark ? '#f8fafc' : '#0f172a', fontSize:'0.875rem', outline:'none', boxSizing:'border-box', transition:'all 0.2s' }} onFocus={e=>{e.target.style.border='1px solid #2563eb';e.target.style.boxShadow='0 0 0 2px rgba(37,99,235,0.2)';}} onBlur={e=>{e.target.style.border=isDark ? '1px solid #334155' : '1px solid #cbd5e1';e.target.style.boxShadow='none';}}/>
                            </div>
                          </div>
                          <div>
                            ...
                            <div className="cx-form-grid-2" style={{ display:'grid', gridTemplateColumns:'1fr auto', gap:'8px', alignItems:'center' }}>
                              <input type="number" onWheel={(e)=>(e.target as any).blur()} placeholder="e.g. 7" value={eventForm.duration} onChange={e=>setEventForm({...eventForm, duration:e.target.value})} style={{ padding:'10px 13px', borderRadius:'6px', border: isDark ? '1px solid #334155' : '1px solid #cbd5e1', background: isDark ? '#0f172a' : '#ffffff', color: isDark ? '#f8fafc' : '#0f172a', fontSize:'0.875rem', outline:'none', boxSizing:'border-box', transition:'all 0.2s' }} onFocus={e=>{e.target.style.border='1px solid #2563eb';e.target.style.boxShadow='0 0 0 2px rgba(37,99,235,0.2)';}} onBlur={e=>{e.target.style.border=isDark ? '1px solid #334155' : '1px solid #cbd5e1';e.target.style.boxShadow='none';}}/>
