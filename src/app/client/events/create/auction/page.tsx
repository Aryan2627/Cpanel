                        ...
                        {creatorFields.map((f: any) => (
                          <div key={f.id}>
                            ...
                            {f.type === 'product' ? (
                                ...
                                onChange={(e) => {
                                  ...
                                  if (prod) {
                                    ...
                                    creatorFields.forEach((otherField: any) => {
                                      if (otherField.key === f.key) return;
                              ...
                              <input 
                                type="text" placeholder={`Search for ${f.name}`} value={creatorData[f.key] || ''} onChange={(e) => setCreatorData({ ...creatorData, [f.key]: e.target.value })}
