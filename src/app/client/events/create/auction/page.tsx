          ...
          <div style={{ background: 'linear-gradient(135deg, #071330 0%, #0d1f4f 55%, #1a2f6b 100%)', padding: '60px 40px 140px', position: 'relative', overflow: 'hidden', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
            ...
            <div style={{ maxWidth: '1200px', margin: '0 auto', position: 'relative', zIndex: 2 }}>
              ...
              <p style={{ margin: 0, fontSize: '1.05rem', color: '#94a3b8', maxWidth: '600px', lineHeight: 1.6 }}>
                Configure real-time competitive bidding rules and invite suppliers.
              </p>
            </div>
          </div>
          ...
          <div style={{ background: 'rgba(255, 255, 255, 0.8)', backdropFilter: 'blur(20px)', borderRadius: '24px', padding: '32px', boxShadow: '0 10px 40px -10px rgba(37,99,235,0.1)', border: '1px solid rgba(255,255,255,1)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '24px' }}>
              ...
              {!isMultiStage ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', background: '#f8fafc', padding: '24px', borderRadius: '16px', border: '1px solid #e2e8f0', boxShadow: 'inset 0 2px 10px rgba(0,0,0,0.02)' }}>
                  {/* Stage 1 */}
...
{/* Buttons */}
        ...
        <div style={{ position: 'relative', marginTop: '16px',  background: 'rgba(255, 255, 255, 0.95)', backdropFilter: 'blur(20px)', borderTop: '1px solid rgba(226, 232, 240, 0.8)', padding: '20px 48px', paddingRight: '80px', display: 'flex', justifyContent: 'space-between', alignItems: 'center',  zIndex: 50 }}>
          <div style={{ display: 'flex', flexDirection: 'column' }}>
