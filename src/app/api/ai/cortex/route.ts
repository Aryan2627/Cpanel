...
export async function POST(req: Request) {
  try {
    ...
    if (/^(hi|hello|hey|greetings|morning|afternoon)\b/.test(text)) {
      return NextResponse.json({
        final_response: `Hello ${firstName}! I am ProcGen Cortex, your AI Procurement Assistant. I am ready to process normal conversations, answer questions, or execute complex workflows like 'Check laptop inventory'.`
      });
    }
